...
public class Test {
	...
	public static void main(String args[]) {	
		...
		new BookChapter("Robert Greiner", 1999, "Explanation-based learning", "The Encyclopedia of Cognitive Science", "Robert Wison and Frank Keil", "MIT Press", "Cambridge", "MA", 301, 303);

		new BookChapter("Mark Twain", 1881, "A Connecticut Yankee in Transcendental Land", "Fear of the Opulent Eyeball and Other Meditations Along the Reflecting Pond", "Mark Twain, Henry David Thoreau, and Ralph Waldo Emerson", "Random House", "New York", "NY", 117, 132);   
				
		new Book("Morgan Ginsberg", 1987, "Readings in Nonmonotonic Reasoning", "Morgan Kaufmann", "Los Altos", "CA", 454);

		new Book("Mark Twain and Henry David Thoreau", 1880, "The Book That Never Was", "Random House", "New York", "NY", 608);

		new Book("Mark Twain, Henry David Thoreau, and Ralph Waldo Emerson", 1881, "Fear of the Opulent Eyeball and Other Meditations Along the Reflecting Pond", "Random House", "New York", "NY", 1573); 

		//don't name this class URL -- Java already uses that name
		new WebReference("Pete Sinah", 2004, "A Memory-Efficient Doubly Linked List", 2, 14, 2013, "http://www.linuxjournal.com/article/6828?page=0,0");

		new WebReference("Android", 2012, 2, 14, 2012, "http://www.android.com");

		new JournalArticle("Adam M. Abdelbar and Sam Morris Hedetniemi", 1998, "Approximating MAPs for belief networks in NP-hard and other theorems", "Artificial Intelligence", 102, 21, 38);
	}
